          ...
          <div class="auth-box h-full flex flex-col justify-center">
            ...
            <form class="space-y-4" action="{{route('password.store')}}" method="POST">
              ...
              <div class="fromGroup">
                ...
                <div class="relative ">
                  <input type="email" name="email" class="  form-control py-2" placeholder="Enter your email" value="{{old('email', $email)}}" >
                </div>
                @error('email')
                      <div class="">
              ...
              <div class="fromGroup">
                <label class="block capitalize form-label">passwrod</label>
                <div class="relative ">
                  <input type="password" name="password_confirmation" class="  form-control py-2" placeholder="Enter your password">
                </div>
