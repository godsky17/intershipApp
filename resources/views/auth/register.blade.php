    ...
    <div class="right-column  relative">
        <div class="inner-content h-full flex flex-col bg-white dark:bg-slate-800">
            <div class="auth-box h-full flex flex-col justify-center">
                ...
                <x-auth.form action="{{ route('register')}}" method="POST">
                    <x-auth.input type="text" name="name" label="Name" value=""  placeholder="Enter your name"></x-auth.input>
                    <x-auth.input type="email" name="email" label="Email" value=""  placeholder="Enter your email"></x-auth.input>
                    <x-auth.input type="password" name="password" label="Password" value=""  placeholder="Enter you password"></x-auth.input>
                    <x-auth.input type="password" name="password_verification" label="Password" value=""  placeholder="Enter you password"></x-auth.input>
